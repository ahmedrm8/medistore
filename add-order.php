        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">ادارة الفاتورة</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">الصفحة الرئيسية</a></li>
                        <li class="breadcrumb-item active">ادارة الفاتور</li>
                    </ol>
                </div>
            </div>
   ...
   $stall_no= $n."".$l; ?>
                                     ...
                                     <div class="form-group">
                                            <div class="row">
                                                ...
                                                <label class="col-sm-2 control-label">رقم الاتصال بالعميل</label>
                                                <div class="col-sm-4">
                                                <input type="text" class="form-control" id="clientContact" name="clientContact" placeholder="رقم الاتصال" autocomplete="off" pattern="^[0][1-9]\d{9}$|^[1-9]\d{9}$" required/>
                                               </div>
          ...
          <thead>
            <tr>              
              <th style="width:40%;">العلاج</th>
              <th style="width:20%;">المعدل</th>
              <th style="width:10%;">الفائدة</th>
              <th style="width:15%;">الكمية</th>              
              <th style="width:25%;">المجموع</th>             
              <th style="width:10%;">الفعل</th>
            </tr>
          </thead>
          <tbody>
            <?php
...
<td >
            ...
            ?>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-2 control-label">المبلغ الفرعي</label>
                                                <div class="col-sm-4">
                                                 <input type="text" class="form-control" id="subTotal" name="subTotal" disabled="true" />
              <input type="hidden" class="form-control" id="subTotalValue" name="subTotalValue" />
                                                </div>

                                                <label for="totalAmount" class="col-sm-2 control-label">المبلغ الفرعي</label>
                                                  <div class="col-sm-4">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label for="discount" class="col-sm-2 control-label">تخفيض</label>
                                                <div class="col-sm-4">
                                                  <input type="text" class="form-control" id="discount" name="discount" onkeyup="discountFunc()" autocomplete="off" / pattern="^[0-9]+$"/>
                                                </div>
                                                <label for="grandTotal" class="col-sm-2 control-label">المجموع الاجمالي</label>
                                                 <div class="col-sm-4">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label for="vat" class="col-sm-2 control-label gst"> %ضريبة السلع والخدمات 18
                                                  <input type="text" class="form-control" id="vat" name="gstn" readonly="true" />
                                                  <input type="hidden" class="form-control" id="vatValue" name="vatValue" />
                                                </div>

                                                <label for="paid" class="col-sm-2 control-label">المبلغ المدفوع</label>
                                               <div class="col-sm-4">
                                             ...
                                             <div class="form-group">
                                            <div class="row">
                                               <label for="due" class="col-sm-2 control-label">مبلغ مستحق</label>
                                               <div class="col-sm-4">
                                                <input type="text" class="form-control" id="due" name="due" disabled="true" />
                                                <input type="hidden" class="form-control" id="dueValue" name="dueValue" />
                                              </div>

                                              <label for="clientContact" class="col-sm-2 control-label">نوع الدفع</label>
            <div class="col-sm-4">
              <select class="form-control" name="paymentType" id="paymentType">
                <option value="">~~اختيار~~</option>
                <option value="2">نقدي</option>
                 <option value="4">اتصل بي</option>
                <option value="5">جوجل الدفع </option>
                <option value="6">امازون الدفع</option>
                <option value="1">يفحص</option>
                <option value="3">بطاقة الائتمان</option>
                                            ...
                                            <div class="form-group">
                                            <div class="row">
                                               <label for="clientContact" class="col-sm-2 control-label">حالة السداد</label>
            <div class="col-sm-4">
              <select class="form-control" name="paymentStatus" id="paymentStatus">
                <option value="">~~اختيار~~</option>
                <option value="1">دفع كامل</option>
                <option value="2">دفعة مقدمة</option>
                <option value="3">لا يوجد دفع</option>
              </select>
            </div>

            <label for="clientContact" class="col-sm-2 control-label">مكان الدفع</label>
            <div class="col-sm-4">
              <select class="form-control" name="paymentPlace" id="paymentPlace">
                <option value="">~~اختيار~~</option>
                <option value="1">في مصر</option>
                <option value="2">خارج مصر</option>
              </select>
            </div>
                                               </div>
                                            </div>
        <div class="form-group submitButtonFooter">
          <div class="col-sm-offset-2 col-sm-10">
            <button type="submit" id="createOrderBtn" data-loading-text="Loading..." class="btn btn-success btn-flat m-b-30 m-t-30"><i class="glyphicon glyphicon-ok-sign"></i> تقيم</button>

            <button type="reset" class="btn btn-danger btn-flat m-b-30 m-t-30" onclick="resetOrderForm()"><i class="glyphicon glyphicon-erase"></i>اعادة ضبط</button>
          </div>
        </div>
