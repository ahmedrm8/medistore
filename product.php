       ...
       <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary"> عرض العلاج</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">الصفحةالرئيسية</a></li>
                        <li class="breadcrumb-item active">عرض العلاج</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="container-fluid">
                 ...
                 <div class="card">
                            ...
                            <a href="add-product.php"><button class="btn btn-primary">اضافة العلاج</button></a>
