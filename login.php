                            ...
                            <div class="login-form">
                                ...
                                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" id="loginForm" class="row">
                                    <div class="form-group col-md-12">
                                        <label lass="col-sm-3 control-label">الايميل</label>
                                        <input type="text" name="email" id="email" class="form-control" placeholder="ادخل الايميل" pattern="[^@\s]+@[^@\s]+\.[^@\s]+" title="Invalid email address"required="">
     
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label>كلمة المرور</label>
                                        <input type="password" pattern="[a-z]{1,15}" id="password" name="password" class="form-control" placeholder="ادخل كلمة المرور" required="">
                                    </div>
                                        ...
                                        <div class="forgot-phone col-md-6 text-right">
                                            <a href="#" class="text-right f-w-600 text-gray">نسيت كلمة المرور</a>
                                        </div>
                                 
                                   <div class="col-md-12"> 
                                       <button style="background-color: #102b49; border-radius: 50px;" type="submit" name="login" class=" f-w-600 text-white btn  btn-flat m-b-30 m-t-30">سجل الدخول</button>
                                   </div>
                                </form>
                            </div>
                        </div>
