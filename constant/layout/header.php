                            ...
                            <div class="dropdown-menu dropdown-menu-right animated zoomIn">
                                <ul class="dropdown-user">
                                   <?php if(isset($_SESSION['userId']) && $_SESSION['userId']==1) { ?>
                                     <li><a href="#"><i class="fa fa-key"></i> تغير الباسورد</a></li>
                                      <li><a href="#"><i class="fa fa-user"></i> اضافة مستخدم</a></li>
                                     <?php }?>
                               
                                    <li><a href="./constant/logout.php"><i class="fa fa-power-off"></i> تسجيل خروج</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
