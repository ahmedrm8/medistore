                       ...
                       <div class="card" style="background: #2BC155 ">
                           <div class="media widget-ten">
                               ...
                               <div class="media-body media-text-right">
                                   ...
                                   <a href="product.php"><p class="m-b-0">اجمالي العلاج</p></a>
                               </div>
                           </div>
                       </div>
                   </div> 
                            ...
                            <div class="media widget-ten">
                                ...
                                <div class="media-body media-text-right">
                                    ...
                                    <h2 class="color-white"><?php echo $countLowStock1; ?></h2>
                                     <a href="product.php"><p class="m-b-0">اجمالي الشركة المصنعةr</p></a>
                                </div>
                            </div>
                        </div>
                    </div>
                   ...
                   <div class="col-md-6 dashboard">
                      <div class="card " style="    background-color: #F94687 ">
                          ...
                          <h2 class="color-white"><?php echo $countLowStock2; ?></h2>
                                  <a href="Order.php"><p class="m-b-0">اجمالي الفواتير</p></a>
                              </div>
                          </div>
                      </div>
                  </div>
                   ...
                   <div class="col-md-6 dashboard">
                      <div class="card" style="    background-color: #FFBC11 ">
                          ...
                          <h2 class="color-white"><?php echo $countLowStock3; ?></h2>
                                  <a href="Order.php"><p class="m-b-0"> اجمالي الادوية المنتهية الصلاحية</p></a>
                              </div>
                          </div>
                      </div>
                  </div>
...
<div class="card">
                            <div class="card-header">
                                <strong class="card-title">فاتورة المستخدم الحكيمة</strong>
    ...
    ?>
                                        <tr>
                                            ...
                                            <td><?php  if($row['paymentStatus']==1)
                                            {
                                                 ...
                                                 $paymentStatus = "<label class='label label-success' ><h4>دفع كامل</h4></label>";
                                                 echo $paymentStatus;
                                            }
                                            else if($row['payment_status']==2){
                                                $paymentStatus = "<label class='label label-danger'><h4>يوجد دفع</h4></label>";
                                                echo $paymentStatus;
                                            }else {
                                                $paymentStatus = "<label class='label label-warning'><h4>لا يوجد دفع</h4></label>";
                                                 echo $paymentStatus;
                                                } // /els
                                            ?></td>
