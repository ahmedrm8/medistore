        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">إدارة الشركات المصنعة للاستيراد</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">الصفحة الرئيسية</a></li>
                        <li class="breadcrumb-item active">استيراد الشركة المصنعة</li>
                    </ol>
                </div>
            </div>
                                ...
                                <div class="input-states">
                                   <form class="form-horizontal" id="submitImportForm" action="php_action/createBrandImport.php" method="POST" enctype="multipart/form-data">
                                    <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label">استيراد ملف الشركة المصنعة</label>
                                                
                                                <div class="col-sm-9">
                                                 <input type="file" class="form-control" id="brandfile" placeholder="ملف عينة" name="brandfile" class="file-loading" style="width:auto;"/>
                                       ...
                                       <button type="submit" class="btn btn-success btn-flat m-b-30 m-t-30" id="importBrandBtn" value="showAlert" onclick="showAlert();">استيراد</button>
                                    </form>
                                </div>
                            </div>
                        </div>
