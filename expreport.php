        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">إدارة تقرير تاريخ انتهاء الصلاحية الطبي</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">الصفحةالرئيسية</a></li>
                        <li class="breadcrumb-item active">>تقرير التاريخ</li>
                    </ol>
                </div>
            </div>
                                ...
                                <div class="input-states">
                                   <form class="form-horizontal" action="getproductreport.php" method="post" id="getOrderReportForm">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label">تاريخ البدء</label>
                                                <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label">تاريخ الانتهاء</label>
                                                <div class="col-sm-9">
                                        ...
                                        <button type="submit"  id="generateReportBtn" class="btn btn-primary btn-flat m-b-30 m-t-30">انشاء تقرير</button>
                                    </form>
                                </div>
                            </div>
                        </div>
